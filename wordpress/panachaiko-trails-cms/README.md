...
## Δημόσιες υποβολές μονοπατιών

Στο **Panachaiko Trails → Κατάσταση Site → Προσθήκη μονοπατιού από επισκέπτες** ο διαχειριστής μπορεί να ενεργοποιεί ή να απενεργοποιεί τις δημόσιες υποβολές. Η προεπιλογή είναι **απενεργοποιημένη**. Το δημόσιο `/site-status` API επιστρέφει το πεδίο `public_trail_submissions`, ώστε το Astro να εμφανίζει το κουμπί «Πρόσθεσε μονοπάτι» μόνο όταν είναι ενεργό. Ενημέρωσε επίσης το πρόσθετο `panachaiko-trails-admin-ui`: αυτό αποκλείει τις φόρμες εγγραφής και υποβολής όταν ο διακόπτης είναι κλειστός.
