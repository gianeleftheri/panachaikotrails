...
final class Panachaiko_Trails_Importer {
    ...
    public static function render_page(): void {
        ...
        <div class="wrap">
            ...
            <p>Επίλεξε ένα ή περισσότερα JSON αρχεία από το υπάρχον <code>src/data/trails/</code>. Ο importer δημιουργεί ή ενημερώνει διαδρομές με βάση το μοναδικό <code>trail_code</code>.</p>
            ...
            <?php elseif ( 'error' === $result ) : ?>
                <div class="notice notice-error"><p>Η εισαγωγή απέτυχε. Έλεγξε ότι τα αρχεία είναι έγκυρα JSON του Panachaiko Trails.</p></div>
            <?php endif; ?>
            ...
            <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" enctype="multipart/form-data">
                ...
                <?php submit_button( 'Εισαγωγή διαδρομών' ); ?>
            </form>
        </div>
        <?php
    }
